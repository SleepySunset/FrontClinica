        ...
        <div className="container-inicio">
            ...
            <div className="crud">
                ...
                <p>OdontoSalud es una clínica odontológica desarrollada como ejercitación para el curso 
                    ...
                    En esta web encontrarás 3 diferentes entidades:{" "}
                    <Link to="/paciente" className="link">Paciente</Link>,{" "}
                    <Link to="/odontologo" className="link">Odontólogo</Link> y 
                    {" "}<Link to="/turno" className="link">Turno</Link>, 
                    las cuales tienen su propio CRUD al que podrás realizar solicitudes 
                    simples gracias a la conexión con nuestra base de datos.
                </p>
                </div>
                <div>
